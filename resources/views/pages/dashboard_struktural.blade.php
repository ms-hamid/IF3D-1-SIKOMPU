...
<main class="flex-1 px-3 sm:px-6 py-4 space-y-6">
 ...
 <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-2 mb-4">
  <div class="items-center p-6 bg-white rounded-xl shadow-sm border border-gray-100 text-left">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2 w-full">
    ...
    <div class="flex justify-between items-center p-6 bg-white rounded-xl shadow-sm border border-gray-100">
      <div>
...
{{-- Alert Peringatan --}}
<div class="flex items-center p-4 text-white bg-red-500 border border-red-600 rounded-lg shadow-sm">
  ...
  <p class="text-sm">
    ...
    <a href="#" class="text-white underline hover:text-gray-100 ml-1">Lihat detail →</a>
  </p>
</div>
    {{-- BARIS 2: 2 KOLOM --}}
    ...
    <div class="bg-white border border-gray-100 rounded-xl shadow-sm p-4">
      ...
      <div class="space-y-4">
        <button class="w-full flex items-center justify-between bg-blue-800 text-white px-4 py-2.5 rounded-lg hover:bg-blue-900 transition">
          <span><i class="fa-solid fa-wand-magic-sparkles mr-2"></i> Generate Rekomendasi</span>
          <i class="fa-solid fa-arrow-right"></i>
        </button>

        <button class="w-full flex items-center justify-between bg-gray-50 text-gray-800 px-4 py-2.5 rounded-lg hover:bg-gray-100 border transition">
...
<div class="bg-white p-6 shadow-lg rounded-sm border border-gray-100 mt-6">
  <div class="flex justify-between items-center mb-3">
    <h3 class="text-sm font-semibold text-gray-800">Distribusi SKS per Dosen</h3>
    <select class="border border-gray-200 text-xs rounded-md px-2 py-1 focus:ring-1 focus:ring-blue-500">
...
{{-- Status Pengisian Section --}}
<div class="bg-white rounded-lg shadow-sm border border-gray-100 p-3 mt-4">
  <h3 class="text-sm font-semibold text-gray-800 mb-3 text-left">Rata - Rata Dosen Self Assesment</h3>
  <div class="flex flex-col items-center">
    <div class="relative h-40 w-40">
      <canvas id="chartPengisian"></canvas>
      <div class="absolute inset-0 flex items-center justify-center text-blue-700 font-bold text-xl">80%</div>
    </div>
    <div class="flex justify-center gap-4 mt-2 text-xs">
      <div class="flex items-center"><span class="w-2.5 h-2.5 bg-blue-700 rounded-full mr-1.5"></span> Sudah Mengisi</div>
      <div class="flex items-center"><span class="w-2.5 h-2.5 bg-gray-300 rounded-full mr-1.5"></span> Belum Mengisi</div>
    </div>
  </div>
</div>
