<!-- resources/views/components/delete-prodi.blade.php -->
<div x-show="openDeleteModal" 
    ...
    <div class="flex min-h-full items-center justify-center p-4">
        <div x-show="openDeleteModal"
            ...
            {{-- Form Delete --}}
            <form :action="`/prodi/${deleteData.id}`" method="POST" class="mt-5">
                @csrf
                @method('DELETE')
                ...
                <div class="flex flex-col-reverse sm:flex-row gap-2">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-trash mr-2"></i>Ya, Hapus Program Studi
                    </button>
                </div>
            </form>
