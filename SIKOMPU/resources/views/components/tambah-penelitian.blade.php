...
<form action="{{ route('penelitian.store') }}" method="POST" class="space-y-4">
    ...
    <div class="flex flex-col">
        <label for="judul_penelitian" class="text-sm font-medium text-gray-700 mb-1">
        ...
        <input type="text" name="judul_penelitian" id="judul_penelitian"
               ...
               class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none @error('judul_penelitian') border-red-500 @enderror"
    ...
    {{-- Tahun Publikasi --}}
    <div class="flex flex-col">
        <label for="tahun" class="text-sm font-medium text-gray-700 mb-1">
            Tahun Publikasi <span class="text-red-500">*</span>
        </label>
        <select name="tahun" id="tahun"
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm @error('tahun') border-red-500 @enderror"
                required>
    ...
    {{-- Peran --}}
    <div class="flex flex-col">
        <label for="peran" class="text-sm font-medium text-gray-700 mb-1">
            Peran <span class="text-red-500">*</span>
        </label>
        <select name="peran" id="peran"
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm @error('peran') border-red-500 @enderror"
                required>
    ...
    {{-- Link Publikasi --}}
    <div class="flex flex-col">
        <label for="link_publikasi" class="text-sm font-medium text-gray-700 mb-1">
        ...
        <input type="url" name="link_publikasi" id="link_publikasi"
               ...
               class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm @error('link_publikasi') border-red-500 @enderror"
