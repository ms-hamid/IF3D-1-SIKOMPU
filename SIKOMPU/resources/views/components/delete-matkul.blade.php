{{-- Modal Delete Confirmation Mata Kuliah --}}
<div x-data="{ 
     ...
     @open-delete-matkul-modal.window="
        showDeleteModal = true;
        matkulId = $event.detail.id;
        matkulNama = $event.detail.nama_mk;
        matkulKode = $event.detail.kode_mk;
        matkulSKS = $event.detail.sks;
        matkulSemester = $event.detail.semester;
     "
     x-cloak>
                ...
                <div class="p-6 text-center">
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-3 mb-4 text-left">
                        <p class="text-sm text-gray-600 mb-1">
                            ...
                            <span class="font-mono" x-text="matkulKode"></span>
                        </p>
                        <p class="font-semibold text-gray-900 mb-1" x-text="matkulNama"></p>
                        <p class="text-sm text-gray-600">
                            <span x-text="matkulSKS"></span> SKS - Semester <span x-text="matkulSemester"></span>
                        </p>
                    </div>
                    ...
                    <div class="flex gap-3 justify-center">
                        ...
                        <form :action="`{{ route('matakuliah.index') }}/${matkulId}`" 
                              method="POST" 
                              class="flex-1">
                            @csrf
                            @method('DELETE')
