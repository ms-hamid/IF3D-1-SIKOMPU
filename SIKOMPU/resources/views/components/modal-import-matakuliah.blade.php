{{-- Modal Import Excel Mata Kuliah --}}
<div x-show="openImportModal" 
    ...
    <div class="flex min-h-full items-center justify-center p-4">
        <div x-show="openImportModal"
            ...
            <form action="{{ route('matakuliah.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="text-sm text-blue-800">
                            ...
                            <ul class="list-disc list-inside space-y-1 text-xs">
                                ...
                                <li>Pastikan Kode Prodi sudah terdaftar di sistem</li>
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-md border border-gray-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">template_import_matakuliah.xlsx</p>
                        </div>
                    </div>
                    <a href="{{ route('matakuliah.template') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                        Download
                    </a>
                </div>
